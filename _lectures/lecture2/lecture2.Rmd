...
I was using the `n_max` argument of the functions above to save space in this lecture script. Now, that we learned about some of the ways in which raw data can be structured, let us go back to the original data that we read in and saved in the variable `gapminder`.
...
-   The file `exercise1.txt` is in an unfamiliar format. Find out how it is structured and read it as a tibble.
